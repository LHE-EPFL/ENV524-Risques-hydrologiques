...
legend('quantiles théoriques s','quantiles empiriques s','quantiles théoriques s2>s','quantiles empiriques s2>s','quantiles théoriques s3<s','quantiles empiriques s3<s', 'Location', 'SouthEast')
